...
<main>
  ...
  <ol>
    <li>Mit der rechten Maustaste (Mac: Ctrl-Klick) auf <b>«Dashboard öffnen»</b> klicken und
      <b>«Link speichern unter …»</b> wählen (Firefox: «Ziel speichern unter …», Safari: «Verknüpfte Datei laden»).</li>
  ...
  <p>In einer solchen Einzelkopie öffnen sich Dossiers, Quelldateien und geführte Formulare auf dieser Website.
  Ganz ohne Internet gehen sie nur mit dem ganzen Repository (auf GitHub «Code» → «Download ZIP», rund 170 MB;
