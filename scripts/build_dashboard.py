...
function writeHash(){
  ...
  if(fromUrl&&history.replaceState){history.replaceState(null,'',h);return;}
  ...
  if(/^#search\//.test(location.hash)&&/^#search\//.test(h)&&history.replaceState){history.replaceState(null,'',h);return;}
